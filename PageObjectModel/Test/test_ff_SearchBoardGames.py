...
class SearchBoardGamesPage_ff(unittest.TestCase):
    ...
    def test_searchBoardGames(self):
        ...
        searchGames.click()
        searchGames.send_keys("07 Zgłoś się")
        ...
        # titleGame = self.driver.find_element_by_xpath("//*[@class='productBaseInfo']//*[@itemprop='name']")
        #
        # print(self.driver.find_element_by_xpath(titleGame).text)
        # assert self.driver.find_element_by_xpath(titleGame).text == "Phalanx Games Polska, gra planszowa 07 Zgłoś się"
